...
void Fun4All_Prdf_Combiner(int nEvents = 0,
			   const string &outdir = "/no/real/path/here/",
			   const string &type = "blah", 
			   const int    &neventsper = 10000,
                           ...
                           const string &zdcinput = "seb20.list")
{
  ...
  */
  ...
  Fun4AllOutputManager *out = new Fun4AllDstOutputManager("TriggerOut", outfilename);
  {
    out->UseFileRule();
